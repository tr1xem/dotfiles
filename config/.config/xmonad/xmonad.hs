  ...
  ewmhFullscreen $
    def
      ...
      , startupHook = do
          ...
          spawn "trayer --edge top --align right --widthtype request --height 24 --tint 0x' <> surfaceDim colors <> ' --alpha 64 --transparent true --expand true --margin 4 -l --iconspacing 3"
      }
